...
class DocReceitaIndex extends Component
{
    use Toast;
    use WithPagination;

    public $page_title = 'Documentos Receita';
    public array $sortBy = ['column' => 'id', 'direction' => 'asc'];
    public string $search = '';
    public $qdeFilter = 0;

    /* Renderiza componente */
    #[Title('Documentos Receita')]
    public function render()
    {
        return view('livewire.documento.doc-receita-index',[
